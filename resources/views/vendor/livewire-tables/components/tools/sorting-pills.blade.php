            ...
            <div class="mb-4 px-4 md:p-0">
                ...
                @foreach($component->getSorts() as $columnSelectName => $direction)
                    ...
                    <span
                        ...
                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-gray-100 text-gray-800 capitalize dark:bg-gray-200 dark:text-gray-900"
                    >
